...
str_write= ""
tc= 0
for fname in glob.glob("/home/hemanta/data/action_items/storage_monitor/project/dashboard_v2/dataset/*.csv"):
	...
	<input type="checkbox" id= chck"""+str(tc)+ """>
    <label class="tab-label" for= chck"""+str(tc)+""">"""+fqhn+"""</label>
...
file_writer= open("dashboard_v2.html", 'w')
