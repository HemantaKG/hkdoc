...
def plot_frequency_job_partition(selected_rows, title, xlabel, ylabel):
    # PART 0: Find the frequency of each Partition
...
def total_cputime_per_user(selected_rows):
...
def total_elapsedtime_per_user(selected_rows):
...
def plot_elapsedtime_cputime_per_user(total_cputime_per_user, total_elapsedtime_per_user, title, xlabel, ylabel):
    # Convert the total CPUTime back to "days-HH:MM:SS" format
    # total_cputime_per_user_str = total_cputime_per_user.apply(seconds_to_time_str)

    # Create a new DataFrame with the total CPUTime and total ElapsedTime for each user
    user_times_df = pd.DataFrame({'Total CPUTime': total_cputime_per_user,
                                'Total ElapsedTime': total_elapsedtime_per_user})

    # Sort the DataFrame by the Total CPUTime (optional, you can remove this line if you don't want sorting)
    user_times_df = user_times_df.sort_values(by='Total CPUTime', ascending=False)

    # Plot the total CPUTime and total ElapsedTime for each user using a line chart
    plt.figure(figsize=(10, 6))
    sns.lineplot(data=user_times_df, markers=True, dashes=False)
    plt.xlabel(xlabel)
    plt.ylabel(ylabel)
    plt.title(title)
    plt.xticks(rotation=45, ha='right')
...
# PART 0: Find the frequency of each Job in Partition
xlabel = 'Partition'
ylabel = 'Frequency'
title = 'Partion Frequency of ReqCPU eq 1 [Year: '+ str(year) +']'
...
# PART 0: Find the Total CPU Time oer User
total_cputime_per_user= total_cputime_per_user(selected_rows_copy)

# Print the total ElapsedTime for each user
# print("Total CPUTime per User:")
# print(total_cputime_per_user)

# PART 0: Find the Total Elapsed Time oer User
total_elapsedtime_per_user= total_elapsedtime_per_user(selected_rows_copy)
...
# Plot the total CPUTime and total ElapsedTime for each user using a line chart
xlabel = 'User'
ylabel = 'Time (days-HH:MM:SS)'
title = 'Total CPUTime and ElapsedTime of Each User [Year: '+ str(year) +']'
# plot_elapsedtime_cputime_per_user(total_cputime_per_user, total_elapsedtime_per_user,title, xlabel, ylabel)
...
xlabel = 'Time Bin'
ylabel = 'Count'
title = 'Job Count of Elapsed Time gt 24H and ReqCPU eq 1 [Year: '+ str(year) +']'
...
xlabel = 'ReqMem Bin'
ylabel = 'Count'
title = 'Job Count of ReqMem bins Elapsed Time gt 24H and ReqCPU eq 1 [Year: '+ str(year) +']'
...
xlabel = 'User'
ylabel = 'Frequency'
title = 'User Frequency of Elapsed Time gt 24H and ReqCPU eq 1 [Year: '+ str(year) +']'
...
xlabel= 'ReqCPUs'
ylabel= 'Frequency'
title = 'ReqCPUs Frequency of gt 24H ReqCPU eq 1[Year: '+ str(year) +']'
...
xlabel = 'Time Bin'
ylabel = 'Count'
title = 'Job Count of Elapsed Time lt 24H and ReqCPU eq 1 [Year: '+ str(year) +']'
...
xlabel = 'ReqMem Bin'
ylabel = 'Count'
title = 'Job Count of ReqMem bins Elapsed Time lt 24H and ReqCPU eq 1 [Year: '+ str(year) +']'
...
xlabel = 'User'
ylabel = 'Frequency'
title = 'User Frequency of Elapsed Time lt 24H and ReqCPU eq 1 [Year: '+ str(year) +']'
...
xlabel= 'ReqCPUs'
ylabel= 'Frequency'
title = 'ReqCPUs Frequency of lt 24H ReqCPu eq 1[Year: '+ str(year) +']'
